...
;; {:version 1, :tested-at "2026-03-27T01:20:02.678125-05:00", :module-hash "-213852603", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "1770237734"} {:id "defn/update-first-match", :kind "defn", :line 5, :end-line 7, :hash "-1796435012"} {:id "defn/bfs-sea-neighbors", :kind "defn", :line 9, :end-line 16, :hash "1694187772"} {:id "defn/build-coast-path", :kind "defn", :line 18, :end-line 21, :hash "925901257"} {:id "defn/passable-sea?", :kind "defn", :line 23, :end-line 27, :hash "-1999367331"} {:id "defn/transport-passable-sea?", :kind "defn", :line 29, :end-line 37, :hash "-1502908338"}]}
