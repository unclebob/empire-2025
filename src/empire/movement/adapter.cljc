...
;; Composite record implementing all 3 protocols for backward compatibility.
;; Consumers that retrieve :movement-port from the context can call any
;; protocol method on this single object.
