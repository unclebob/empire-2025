...
;; {:version 1, :tested-at "2026-03-12T11:59:19.998847-05:00", :module-hash "-1169377561", :forms [{:id "form/0/ns", :kind "ns", :line 2, :end-line 2, :hash "-952559796"} {:id "defn/on-same-continent?", :kind "defn", :line 4, :end-line 10, :hash "-2043680342"} {:id "defn/merge-continents", :kind "defn", :line 12, :end-line 24, :hash "1559328188"}]}
