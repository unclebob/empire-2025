...
(defn decide-production [city-pos]
  (profiling/time-phase :process-computer/city-refresh-map
                        refresh-computer-map!)
  (profiling/time-phase :process-computer/city-decide-production
                        #(decisions/decide-production city-pos)))

(defn process-computer-city [pos]
  (profiling/time-phase :process-computer/city-refresh-map
                        refresh-computer-map!)
  (profiling/time-phase :process-computer/city-process-production
