...
;; {:version 1, :tested-at "2026-03-13T16:09:22.459223-05:00", :module-hash "-1292558443", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 1, :hash "-339645299"} {:id "defn/one-coast-role-counts", :kind "defn", :line 3, :end-line 10, :hash "-1209047307"}]}
