...
(defn- arrival-phase
  [suffix]
  (keyword "process-computer" (str "fighter-arrival-" suffix)))
...
(defn- reachable-city-hop-paths
  [world start sites]
  (profiling/time-phase (arrival-phase "reachable-hop-paths")
                        (fn []
...
(defn best-sortie-staging-plan
  ...
  (profiling/time-phase (arrival-phase "staging-plan")
                        (fn []
...
(defn- max-sortie-plan
  ...
  (profiling/time-phase (arrival-phase "max-sortie-plan")
                        (fn []
...
(defn- choose-exploration-plan
  [world sites pos]
  (profiling/time-phase (arrival-phase "exploration-plan")
                        (fn []
                          (let [site-distance (cached-site-distance-fn)
...
(defn exploration-flight-action
  ...
  (profiling/time-phase (arrival-phase "launch-exploration")
                        (fn []
...
(defn arrival-action
  ...
  (profiling/time-phase (arrival-phase "action")
                        (fn []
