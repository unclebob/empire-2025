...
(defmethod unit-stamping/stamp-computer-fields :default
  [unit cell]
  (-> unit
...
(defmethod unit-stamping/apply-coast-walk-fields :default
...
(defmethod unit-stamping/apply-random-explore-fields :default
  [unit item cell]
  (if (and (= item :army)
           (= :computer (:owner unit))
