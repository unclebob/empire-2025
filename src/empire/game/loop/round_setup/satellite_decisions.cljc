...
;; {:version 1, :tested-at "2026-03-27T02:04:59.757316-05:00", :module-hash "1020877673", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 1, :hash "705496148"} {:id "defn/satellite-step-action", :kind "defn", :line 3, :end-line 9, :hash "-501197628"} {:id "defn/finish-round-action", :kind "defn", :line 11, :end-line 17, :hash "-1103773186"}]}
